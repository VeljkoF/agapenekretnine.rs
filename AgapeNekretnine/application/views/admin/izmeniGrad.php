        ...
        <div class="container">
            <div class="blog">
                <div class="single-inline">
                    <p><a href="<?php echo base_url()?>admin/AdminNekretnine/dodajGrad">Назад</a></p>
                    <h3 style="text-align: center">Измени град: </h3>
                        <?php echo @$obavestenje; ?>
                    <?php echo @$bla; ?>
                        <?php echo form_open_multipart('admin/AdminNekretnine/izmeniGrad/'.$grad[0]->id_grada, $forma_podaci); ?>
